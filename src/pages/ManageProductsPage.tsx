    ...
    return (
                ...
                <CardContent className="grid gap-4">
                    ...
                    <form onSubmit={handleSubmit} className="p-6 border border-gray-300 rounded-md">
                        <div className="grid gap-2 mb-4">
                            <input id="name" type="text" placeholder=" Sports Shoe " className="p-2 w-full border border-gray-300 rounded-md" required />
                        </div>
                        <div className="grid gap-2 mb-4">
                            <input id="category" type="text" placeholder=" Shoe " className="p-2 w-full border border-gray-300 rounded-md" required />
                        </div>
                        <div className="grid gap-2 mb-4">
      ...
      <div className="grid gap-2 mb-4">
        <input id="image" type="text" step="0.01" placeholder="Image" className="p-2 w-full border border-gray-300 rounded-md" required />
                        ...
                        <Button type="submit" variant='outline' className="px-4 py-2 w-full bg-lime-400 text-black  rounded-md hover:scale-90 transition-all mt-10 ">Submit</Button>
                    </form>
